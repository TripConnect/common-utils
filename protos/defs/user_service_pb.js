...
goog.exportSymbol('proto.backend.user_service.SearchUserResponse', null, global);
 ...
 * @constructor
 */
proto.backend.user_service.SearchUserResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.backend.user_service.SearchUserResponse.repeatedFields_, null);
};
goog.inherits(proto.backend.user_service.SearchUserResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.backend.user_service.SearchUserResponse.displayName = 'proto.backend.user_service.SearchUserResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.backend.user_service.SearchUserResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.backend.user_service.SearchUserResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.backend.user_service.SearchUserResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.backend.user_service.SearchUserResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.user_service.SearchUserResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.backend.user_service.SearchUserResponse}
 */
proto.backend.user_service.SearchUserResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.backend.user_service.SearchUserResponse;
  return proto.backend.user_service.SearchUserResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.backend.user_service.SearchUserResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.backend.user_service.SearchUserResponse}
 */
proto.backend.user_service.SearchUserResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.backend.user_service.SearchUserResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.backend.user_service.SearchUserResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.backend.user_service.SearchUserResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.user_service.SearchUserResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.backend.user_service.SearchUserResponse.prototype.getUsersList = function() {
 ...
 * @return {!proto.backend.user_service.SearchUserResponse} returns this
*/
proto.backend.user_service.SearchUserResponse.prototype.setUsersList = function(value) {
 ...
 * @return {!proto.backend.user_service.UserInfo}
 */
proto.backend.user_service.SearchUserResponse.prototype.addUsers = function(opt_value, opt_index) {
 ...
 * @return {!proto.backend.user_service.SearchUserResponse} returns this
 */
proto.backend.user_service.SearchUserResponse.prototype.clearUsersList = function() {
