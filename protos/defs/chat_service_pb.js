...
goog.exportSymbol('proto.backend.chat_service.SearchConversationsPaginationResponse', null, global);
...
proto.backend.chat_service.SearchConversationsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.backend.chat_service.SearchConversationsRequest.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.backend.chat_service.SearchConversationsPaginationResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.backend.chat_service.SearchConversationsPaginationResponse.repeatedFields_, null);
};
goog.inherits(proto.backend.chat_service.SearchConversationsPaginationResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.backend.chat_service.SearchConversationsPaginationResponse.displayName = 'proto.backend.chat_service.SearchConversationsPaginationResponse';
}
...
proto.backend.chat_service.ChatMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    messageContent: jspb.Message.getFieldWithDefault(msg, 4, ""),
...
/**
 * optional string message_content = 4;
 * @return {string}
 */
proto.backend.chat_service.ChatMessage.prototype.getMessageContent = function() {
 ...
 * @return {!proto.backend.chat_service.ChatMessage} returns this
 */
proto.backend.chat_service.ChatMessage.prototype.setMessageContent = function(value) {
 ...
 * @return {string}
 */
proto.backend.chat_service.CreateChatMessageRequest.prototype.getMessageContent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.backend.chat_service.CreateChatMessageRequest} returns this
 */
proto.backend.chat_service.CreateChatMessageRequest.prototype.setMessageContent = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @const
 */
proto.backend.chat_service.Conversation.repeatedFields_ = [4,5];
 ...
 */
proto.backend.chat_service.Conversation.prototype.getMessagesList = function() {
  return /** @type{!Array<!proto.backend.chat_service.ChatMessage>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.backend.chat_service.ChatMessage, 5));
};
 ...
 * @return {!proto.backend.chat_service.Conversation} returns this
*/
proto.backend.chat_service.Conversation.prototype.setMessagesList = function(value) {
 ...
 * @return {!proto.backend.chat_service.ChatMessage}
 */
proto.backend.chat_service.Conversation.prototype.addMessages = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.backend.chat_service.ChatMessage, opt_index);
};
 ...
 * @return {!proto.backend.chat_service.Conversation} returns this
 */
proto.backend.chat_service.Conversation.prototype.clearMessagesList = function() {
 ...
 * @const
 */
proto.backend.chat_service.SearchConversationsRequest.repeatedFields_ = [2];
...
proto.backend.chat_service.SearchConversationsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    messagePageSize: jspb.Message.getFieldWithDefault(msg, 6, 0)
  };
 ...
 * @return {!Array<string>}
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.getMemberIdsList = function() {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.setMemberIdsList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.addMemberIds = function(value, opt_index) {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.clearMemberIdsList = function() {
  return this.setMemberIdsList([]);
};
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.clearTerm = function() {
 ...
 * @return {boolean}
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.hasTerm = function() {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.clearPageNumber = function() {
 ...
 * @return {boolean}
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.hasPageNumber = function() {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.clearPageSize = function() {
 ...
 * @return {boolean}
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.hasPageSize = function() {
  return jspb.Message.getField(this, 5) != null;
};


/**
 * optional int32 message_page_size = 6;
 * @return {number}
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.getMessagePageSize = function() {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsRequest} returns this
 */
proto.backend.chat_service.SearchConversationsRequest.prototype.setMessagePageSize = function(value) {
 ...
 * @const
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.backend.chat_service.SearchConversationsPaginationResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.backend.chat_service.SearchConversationsPaginationResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.backend.chat_service.SearchConversationsPaginationResponse}
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.backend.chat_service.SearchConversationsPaginationResponse;
  return proto.backend.chat_service.SearchConversationsPaginationResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.backend.chat_service.SearchConversationsPaginationResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.backend.chat_service.SearchConversationsPaginationResponse}
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.backend.chat_service.SearchConversationsPaginationResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.backend.chat_service.SearchConversationsPaginationResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.getConversationsList = function() {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsPaginationResponse} returns this
*/
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.setConversationsList = function(value) {
 ...
 * @return {!proto.backend.chat_service.Conversation}
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.addConversations = function(opt_value, opt_index) {
 ...
 * @return {!proto.backend.chat_service.SearchConversationsPaginationResponse} returns this
 */
proto.backend.chat_service.SearchConversationsPaginationResponse.prototype.clearConversationsList = function() {
